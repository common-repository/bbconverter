<?php
/*
Plugin Name: BBConverter for PunBB
Plugin URI: http://www.bbconverter.com/
Description: Convert PunBB forum software into bbpress.
Author: Adam Ellis
Version: 1.3
 ...
 */
class Punbb extends BBConverterBase
{
	...
	public function setup_globals()
	{
		...
		$this->field_map[] = array(
			'from_tablename' => 'categories', 'from_fieldname' => 'id',
			'to_type' => 'forum', 'to_fieldname' => '_bbc_forum_id'
		);
		
		// Forum parent id.  If no parent, than 0. Stored in postmeta.
		$this->field_map[] = array(
			'from_tablename' => 'categories', 'from_fieldname' => 'cat_id',
			'to_type' => 'forum', 'to_fieldname' => '_bbc_parent_id'
		);
		
		// Forum title.
		$this->field_map[] = array(
			'from_tablename' => 'categories', 'from_fieldname' => 'forum_name',
		...
		// Forum description.
		$this->field_map[] = array(
			'from_tablename' => 'categories', 'from_fieldname' => 'forum_desc',
		...
		$this->field_map[] = array(
			'from_tablename' => 'categories', 'from_fieldname' => 'disp_position',
		...
		// Forum parent id.  If no parent, than 0. Stored in postmeta.
		$this->field_map[] = array(
			'from_tablename' => 'forums', 'from_fieldname' => 'cat_id',
			'to_type' => 'forum', 'to_fieldname' => '_bbc_parent_id'
		);
		...
		// Forum display order.  Starts from 1.
		$this->field_map[] = array(
			'from_tablename' => 'forums', 'from_fieldname' => 'disp_position',
			'to_type' => 'forum', 'to_fieldname' => 'menu_order'
		);
		...
		$this->field_map[] = array(
			'from_tablename' => 'topics', 'from_fieldname' => 'id',
		...
		// Topic author.
		$this->field_map[] = array(
			'from_tablename' => 'topics', 'from_fieldname' => 'postuserid',
		...
		$this->field_map[] = array(
			'from_tablename' => 'topics', 'from_fieldname' => 'forumid',
		...
		// Topic date update.
		$this->field_map[] = array(
			'from_tablename' => 'topics', 'from_fieldname' => 'dateline',
