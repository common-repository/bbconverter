<?php
/*
Plugin Name: BBConverter for PhpBB
Plugin URI: http://www.bbconverter.com/
Description: Convert PhpBB forum software into bbpress.
Author: Adam Ellis
Version: 1.3
 ...
 */
class Phpbb extends BBConverterBase
{
	...
	public function setup_globals()
	{
		...
		$this->field_map[] = array(
			'from_tablename' => 'forums', 'from_fieldname' => 'display_on_index',
			'to_type' => 'forum', 'to_fieldname' => 'menu_order'
		);
		
		// Forum date update.
		$this->field_map[] = array(
			'to_type' => 'forums', 'to_fieldname' => 'forum_last_post_time',
		...
		$this->field_map[] = array(
			...
			'join_tablename' => 'topics', 'join_type' => 'INNER', 'join_expression' => 'USING (topic_id) WHERE posts.post_id = topics.topic_first_post_id',
