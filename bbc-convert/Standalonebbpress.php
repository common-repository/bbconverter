<?php
/*
Plugin Name: BBConverter for bbPress Stand Alone
Plugin URI: http://www.bbconverter.com/
Description: Convert bbPress Stand Alone forum software into bbpress plugin.
Author: Adam Ellis
Version: 1.3
 ...
 */
class Standalonebbpress extends BBConverterBase
{
	...
	public function setup_globals()
	{
		...
		// Forum description.
		$this->field_map[] = array(
			'from_tablename' => 'forums', 'from_fieldname' => 'forum_desc',
		...
		$this->field_map[] = array(
			'from_tablename' => 'forums', 'from_fieldname' => 'forum_order',
		...
		// Topic author.
		$this->field_map[] = array(
			'from_tablename' => 'topics', 'from_fieldname' => 'topic_poster',
		...
		$this->field_map[] = array(
			...
			'join_tablename' => 'topics', 'join_type' => 'INNER', 'join_expression' => 'USING (topic_id) WHERE posts.post_position = 1',
		...
		// Topic title.
		$this->field_map[] = array(
			'from_tablename' => 'topics', 'from_fieldname' => 'topic_title',
		...
		// Topic date update.
		$this->field_map[] = array(
			'from_tablename' => 'topics', 'from_fieldname' => 'topic_start_time',
		...
		$this->field_map[] = array(
			'from_tablename' => 'topics', 'from_fieldname' => 'topic_time',
		...
		// Topic id.
		$this->field_map[] = array(
			'from_tablename' => 'term_relationships', 'from_fieldname' => 'object_id',
		...
		// Taxonomy ID.
		$this->field_map[] = array(
			'from_tablename' => 'term_taxonomy', 'from_fieldname' => 'term_taxonomy_id',
			'join_tablename' => 'term_relationships', 'join_type' => 'INNER', 'join_expression' => 'USING (term_taxonomy_id)',
			'to_type' => 'tags', 'to_fieldname' => 'taxonomy'
		);	
				
		// Tags text.
		$this->field_map[] = array(
			'from_tablename' => 'terms', 'from_fieldname' => 'name',
			'join_tablename' => 'term_taxonomy', 'join_type' => 'INNER', 'join_expression' => 'USING (term_id)',
		...
		$this->field_map[] = array(
			'from_tablename' => 'posts', 'from_fieldname' => 'post_id', 'from_expression' => 'WHERE posts.post_position != 1',
...
*/
		...
		$this->field_map[] = array(
			'from_tablename' => 'users', 'from_fieldname' => 'ID',
...
*/
		...
		// User name.
		$this->field_map[] = array(
			'from_tablename' => 'users', 'from_fieldname' => 'user_login',
		...
		// User homepage.
		$this->field_map[] = array(
			'from_tablename' => 'users', 'from_fieldname' => 'user_url',
			'to_type' => 'user', 'to_fieldname' => 'user_url'
		);
		
		// User registered.
		$this->field_map[] = array(
			'from_tablename' => 'users', 'from_fieldname' => 'user_registered',
